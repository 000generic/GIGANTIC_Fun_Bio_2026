...
declare -A TABLE_MAP=(
    ["1-output/1_ai-orthogroups_X_leonid.tsv"]="1_ai-orthogroups_X_leonid.tsv"
...
for src_rel in "${!TABLE_MAP[@]}"; do
    ...
    if [ -f "OUTPUT_pipeline/${src_rel}" ]; then
        ln -sf "../../../BLOCK_orthogroups_X_leonid_08july2026/${WORKFLOW_DIR_NAME}/OUTPUT_pipeline/${src_rel}" \
