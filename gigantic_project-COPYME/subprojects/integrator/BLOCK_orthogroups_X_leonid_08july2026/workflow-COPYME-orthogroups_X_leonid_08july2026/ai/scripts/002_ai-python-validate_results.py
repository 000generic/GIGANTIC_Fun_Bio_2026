#!/usr/bin/env python3
# AI: Claude (Cursor) | Opus 4.8 | 2026 July 08 | Purpose: Fail-fast validation of the orthogroups_X_leonid table (§36)
# Human: Eric Edsinger

"""
Script 002 — Validate the orthogroups_X_leonid table (fail-fast, §36).
...
def main():
    parser = argparse.ArgumentParser( description = "Validate the orthogroups_X_leonid table" )
    ...
    with open( table_path, 'r' ) as input_table:
        ...
        for line in input_table:
            ...
            # deconvolution: sum of tip columns == member_count
    ...
    report_lines = [
        status,
        "=" * 70,
        "GIGANTIC integrator - orthogroups_X_leonid_08july2026 validation report",
        "=" * 70,
        "",
