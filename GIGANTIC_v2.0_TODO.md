...
**Canonical convention**: convention 65 in `gigantic_project-COPYME/ai/ai_FYIs/gigantic_conventions.md`

**COPYME copy**: `gigantic_project-COPYME/GIGANTIC_v2.0_TODO.md` (keep in sync).
...
- [ ] Create and validate `workflow-RUN_6-sequence_groups` (timestamp pilot run)
- [ ] Create integrator pilot RUN(s) and verify stable `output_to_input/` aliases
